...
windo.iconbitmap('E:/SmartPaddyAdvisor/backend/CNN/images/rice.ico')
windo.resizable(0,0)
...
def prediction():
    ...
    img = load_image(path)
    try:
        with open('E:/SmartPaddyAdvisor/backend/CNN/model/Rice_Leaves_Disease_Detection.pkl', 'rb') as f:
            clf = pickle.load(f)
...
ri = PIL.Image.open('E:/SmartPaddyAdvisor/backend/CNN/images/rice.png')
